...
<head>
		...
		<title>Stream Vibes audioview</title>
		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
                ...
                <div class="row">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <?php
                            include('connect.php');
                            $select_product = mysqli_query($GLOBALS["conn"], "SELECT * FROM `audio`");
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <!-- delete working -->
                                        <td>
                                            <a href="audioview.php?delete=<?php echo $row['id'] ?>" class="btn btn-outline-danger"><i class="fa fa-trash">
                                                </i>
                                                DELETE
                                            </a>
                                        </td>
                                        <td>
                                            <a href="audioupdate.php?edit=<?php echo $row['id'] ?>" class="btn btn-outline-success"><i class="fa fa-edit">
                                                </i>
                                                EDIT
                                            </a>
                                        </td>
				...
				if (isset($_GET['delete'])) {
                    ...
                    $delete_query = mysqli_query($connection, "DELETE FROM audio WHERE id = $delete_id");
                    if ($delete_query) {
                        echo "
                <script>
