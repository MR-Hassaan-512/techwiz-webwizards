...
if (isset($_POST['add_image'])) {
    ...
    $p_img_folder = 'slider/' . $p_img;

    $insert_query = mysqli_query($conn, "insert into 
    slider_add(Name,paragraph,Image) values('$p_name','$p_img','$paragraph')");
    if ($insert_query) {
    ...
    <div class="container ">
        <div class="row">
            <div class="col-12 mr-4">
                <h1 class="text-center">ADD Slider Image</h1>
                <br><br>
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <label for="p_name"> PRODUCT paragraph</label>
                    <input type="text" class="form-control" name="paragraph"><br><br>
