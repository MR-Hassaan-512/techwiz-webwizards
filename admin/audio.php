...
<head>
		...
		<title>Stream Vibes Audio</title>
			...
			<div class="content-wrapper">
				...
				<section class="content-header">					
					<div class="container-fluid my-2">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="text-center">Audios/Songs</h1>
							</div>
    ...
    <form action="audioview.php" method="post" enctype="multipart/form-data">
        ...
        <input type="file" class="form-control" name="audio" accept="audio/*" required><br>
