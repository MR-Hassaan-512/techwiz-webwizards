            ...
            <div class="section">
                ...
                <div class="heading">
                    <div class="d-flex flex-wrap align-items-end">
                        ...
                        <a href="songs.php" class="btn btn-sm btn-pill btn-air btn-primary">View All</a>
                    </div>
                    <hr>
                </div>
                        ...
                        <div class="col-sm-5 pb-4">
                            <div class="h-100 event event-v bg-img bg-img-radius-lg" style="background-image: url('../assets/images/background/vertical/1.jpg')">
                                <div class="event-content p-4">
                                    <a href="event-details.php"><h6>New Year Party</h6></a>
                        ...
                        <div class="col-sm-7">
                            <div class="h-50 pb-4">
                                <div class="h-100 event event-h bg-img bg-img-radius-lg" style="background-image: url('../assets/images/background/horizontal/1.jpg')">
                                    <div class="event-content p-4">
                                        <a href="event-details.php"><h6>Dance with DJ Nowan</h6></a>
                            ...
                            <div class="h-50 pb-4">
                                <div class="h-100 event event-h bg-img bg-img-radius-lg" style="background-image: url('../assets/images/background/horizontal/2.jpg')">
                                    <div class="event-content p-4">
                                        <a href="event-details.php"><h6>Move You's Legs</h6></a>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae consectetur, ex explicabo.</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="section">
                ...
                <div class="heading">
                    <div class="d-flex flex-wrap align-items-end">
                        ...
                        <a href="artists.php" class="btn btn-sm btn-pill btn-air btn-primary">View All</a>
                    </div>
                    <hr>
                </div>
                ...
                <div class="carousel-item-6 arrow-pos-2">
                    <div class="custom-card">
                        ...
                        <a href="artist-details.php" class="custom-card--link mt-2">
            ...
            <div class="section">
                ...
                <div class="heading">
                    <div class="d-flex flex-wrap align-items-end">
                        ...
                        <a href="playlist.php" class="btn btn-sm btn-pill btn-air btn-primary">View All</a>
                    </div>
                    <hr>
                </div>
            ...
            <div class="section">
                ...
                <div class="heading">
                    <div class="d-flex flex-wrap align-items-end">
                        ...
                        <a href="stations.php" class="btn btn-sm btn-pill btn-air btn-primary">View All</a>
                    </div>
                    <hr>
                </div>
            ...
            <div class="section">
                ...
                <div class="heading">
                    <div class="d-flex flex-wrap align-items-end">
                        ...
                        <a href="genres.php" class="btn btn-sm btn-pill btn-air btn-primary">View All</a>
                    </div>
                    <hr>
                </div>
